...
quick_discount("coben_value_trim_r2", coben_value_trim, dr = 2)
...
ggsave("figures/fig4.png", plot = p3, width = 6.5, height = 3, dpi = 300)
...
ggsave("figures/fig5.png", plot = p2, width = 6.5, height = 2, dpi = 300)
...
cba_discountrange(dr_min = dr_lb, dr_max = dr_ub, annual_coben = coben_value_trim_r2, scenario_lifetime = scenario_years)
...
ashp_ref_ghg_total <- ashp_ref_ghg_natgas[, -1] + ashp_ref_ghg_elec[, -1]
ashp_intv_ghg_total <- ashp_intv_ghg_natgas[, -1] + ashp_intv_ghg_elec[, -1]
weatherize_ref_ghg_total <- weatherize_ref_ghg_natgas[, -1] + weatherize_ref_ghg_elec[, -1]
weatherize_intv_ghg_total <- weatherize_intv_ghg_natgas[, -1] + weatherize_intv_ghg_elec[, -1]
hpwh_ref_ghg_total <- hpwh_ref_ghg_natgas[, -1] + hpwh_ref_ghg_elec[, -1]
hpwh_intv_ghg_total <- hpwh_intv_ghg_natgas[, -1] + hpwh_intv_ghg_elec[, -1]

ref_ghg_s1n2total <- ashp_ref_ghg_total + weatherize_ref_ghg_total + hpwh_ref_ghg_total
intv_ghg_s1n2total <- ashp_intv_ghg_total + weatherize_intv_ghg_total + hpwh_intv_ghg_total
