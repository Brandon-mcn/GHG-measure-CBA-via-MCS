...
ghg_lb1 <- ghg_stats[25,2]
ghg_lb2 <- ghg_stats[25,3] 
ghg_median <- ghg_stats[25,4]
ghg_ub2 <- ghg_stats[25,5]
ghg_ub1 <- ghg_stats[25,6]
...
cba_econ_plot("npv_econ_plot", npv_stats, c = "orangered4", ylab = "NPV (USD)", panel = "a")
cba_social_plot("npv_social_plot", npv_stats, c = "orangered4", ylab = NULL, panel = "b")
cba_econ_plot("sroi_econ_plot", sroi_stats, c = "deepskyblue4", ylab = "SROI (benefits:costs)", panel = "c")
cba_social_plot("sroi_social_plot", sroi_stats, c = "deepskyblue4", ylab = NULL, panel = "d")
cba_econ_plot("lcca_econ_plot", lcca_stats, c = "seagreen4", ylab = "LCCA (cost/tco2e)", panel = "e")
cba_social_plot("lcca_social_plot", lcca_stats, c = "seagreen4", ylab = NULL, panel = "f")
...
ggplot(npv_social, aes(x = npv_social[,1])) +
  ...
  scale_x_continuous(labels = comma, breaks = scales::breaks_extended(n = 5)) +
  theme_minimal()
...
ggplot(npv_stats, aes(x = dr, y = econ_median)) +
  ...
  geom_ribbon(aes(ymin = econ_lb1, ymax = econ_ub1, group = 1), fill = "darkgreen", alpha = 0.5) +  # Shaded confidence interval
