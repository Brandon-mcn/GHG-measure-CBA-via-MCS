...
cashflow_private <- intv_capex1 - ref_capex1
...
p1_ghg_mitigation <- ghg_mitigation[, -1]
```
...
coben1_value <- p1_ghg_mitigation * coben1
...
coben_value_sum <- rowSums(total_coben_value[,4:scenario_lifetime])
