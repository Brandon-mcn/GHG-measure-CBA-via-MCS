...
discrete_uniform2("intv_boundary_mgnl", minvalue = 120, maxvalue = 160, units = "project count")
...
calculate_AD1("ashp_ref_ann_data1", "ashp_intv_ann_data1", ashp_boundary_mgnl, ref_mean = 4146, ref_sd = 233, intv_min = 0.31, intv_max = 0.47, units = "kWh")
...
# The intervention factor is simulated for each home based on a uniform distribution
# The function outputs total reference and intervention scenario energy consumption for all homes in boundary
calculate_AD1("ashp_ref_ann_data2", "ashp_intv_ann_data2", ashp_boundary_mgnl, ref_mean = 603, ref_sd = 11.3, intv_min = 0.31, intv_max = 0.47, units = "therms")
...
```{r}
# Weatherization factor 1 simulates the annual electricity consumption for space heating and cooling in a residential home
# The reference factor is simulated for each home based on a normal distribution 
# The intervention factor is simulated for each home based on a uniform distribution
# The function outputs total reference and intervention scenario energy consumption for all homes in boundary
calculate_AD1("weatherize_ref_ann_data1", "weatherize_intv_ann_data1", weatherize_boundary_mgnl, ref_mean = 4146, ref_sd = 233, intv_min = 0.10, intv_max = 0.20, units = "kWh")

# Calculate cumulative activity data
cumul_sum("weatherize_ref_data1", weatherize_ref_ann_data1)
cumul_sum("weatherize_intv_data1", weatherize_intv_ann_data1)

# Weatherization factor 2 simulates the annual natural gas consumption for space heating and cooling in a residential home
# The reference factor is simulated for each home based on a normal distribution 
# The intervention factor is simulated for each home based on a uniform distribution
# The function outputs total reference and intervention scenario energy consumption for all homes in boundary
calculate_AD1("weatherize_ref_ann_data2", "weatherize_intv_ann_data2", weatherize_boundary_mgnl, ref_mean = 603, ref_sd = 11.3, intv_min = 0.10, intv_max = 0.20, units = "therms")
...
```{r}
# HPWH factor 1 simulates the annual electricity consumption for water heating in a residential home
# The reference factor is simulated for each home based on a normal distribution 
# The intervention factor is simulated for each home based on a uniform distribution
# The function outputs total reference and intervention scenario energy consumption for all homes in boundary
calculate_AD1("hpwh_ref_ann_data1", "hpwh_intv_ann_data1", hpwh_boundary_mgnl, ref_mean = 2969, ref_sd = 108.1, intv_min = 0.30, intv_max = 0.70, units = "kWh")

# Calculate cumulative activity data
cumul_sum("hpwh_ref_data1", hpwh_ref_ann_data1)
cumul_sum("hpwh_intv_data1", hpwh_intv_ann_data1)

# HPWH factor 2 simulates the annual natural gas consumption for water heating in a residential home
# The reference factor is simulated for each home based on a normal distribution 
# The intervention factor is simulated for each home based on a uniform distribution
# The function outputs total reference and intervention scenario energy consumption for all homes in boundary
calculate_AD1("hpwh_ref_ann_data2", "hpwh_intv_ann_data2", hpwh_boundary_mgnl, ref_mean = 237, ref_sd = 4, intv_min = 0.30, intv_max = 0.70, units = "therms")
...
weatherize_outputlist <- (list("weatherize_boundary_mgnl" = weatherize_boundary_mgnl,
                         "weatherize_boundary" = weatherize_boundary,
