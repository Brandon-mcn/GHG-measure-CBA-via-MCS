...
Air source heat pumps (ASHP): simulations
```{r}
...
calculate.AD("ashp_ref1", "ashp_intv1", ashp_count, ref_mean = 4146, ref_sd = 233, intv_min = 0.31, intv_max = 0.47, "kWh")

# ASHP Reference factor 2 simulates the annual natural gas consumption for space heating and cooling in a residential home
normal.PDF("ashp_ref2", 603, 11.3)
